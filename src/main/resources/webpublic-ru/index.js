...
function getToAnswerJson() {
	$.get("/q/?toAnswer", function(r) { showQuestionList($("#toAnswer"), "В очереди", r); });
}
function getInProgressJson() {
	$.get("/q/?inProgress", function(r) { showQuestionList($("#inProgress"), "В процессе", r); });
}
function getAnsweredJson() {
	$.get("/q/?answered", function(r) { showQuestionList($("#answered"), "Готово", r); });
}
