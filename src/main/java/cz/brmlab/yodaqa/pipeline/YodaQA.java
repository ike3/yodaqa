...
public class YodaQA /* XXX: extends AggregateBuilder ? */ {
	static {
		...
		try {
			...
			//SolrNamedSource.register("guten", "bigdata", "http://nl.opensolr.com/solr/bigdata");
			SolrNamedSource.register("guten", "bigdata", System.getProperty("cz.brmlab.yodaqa.solr_url"));
